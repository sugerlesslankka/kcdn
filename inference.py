...
raw_image = Image.open('../dataset/MSCOCO_Caption/val2014/COCO_val2014_0000000'+str(id)+'.jpg').convert("RGB")
raw_image.save(cap+".png")
# raw_image.show(title=cap)

image = io1.imread('../dataset/MSCOCO_Caption/val2014/COCO_val2014_0000000'+str(id)+'.jpg')
